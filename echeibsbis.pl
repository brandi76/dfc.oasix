...
$total=0;
$total_page=0;
print "<font color=navy>$#ECHEANCIER";
foreach (@ECHEANCIER){
...
print "<br><center><a href=echeibsbis.pl>nouvelle requête</a></center>";
print <<"eof";
<br><br>
...
eof
&tete("ECHEANCIER BIS","/home/var/spool/uucppublic/echeanc.txt","oui");
print <<"eof";
<form action=echeibsbis.pl name=choix>
