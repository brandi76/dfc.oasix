...
{ 
	 ...
	 exec("/home/intranet/cgi-bin/choix-col.pl produit $code_produit http://intranet.dom/cgi-bin/statproduit-do.pl?tous=\"on&calcul=on&print=on&type_autres=on&type_cd=on&toutes=on&code_produit=\" 2");
...
&affiche( "<tr bgcolor=#e8e8e8><td>Code Produit</td><td>Designation</td><td>Famille</td><td>Code franchise</td></tr>\n");        
...
print "<br><center><a href=statproduit-do.pl>nouvelle requête</a></center>";
print <<"eof";
<br><br>
...
eof
print "<font size=4><b>@famille_auto;$#famille_auto:$#famillet_auto</b></font>";
#for ($i=0;$i<=$#f_ht;$i++){
#	
...
sub stat{
         ...
         $totalp=0;
         $totalm=0;
         print "<center><table border=1 width=80%><tr><td><b>Famille</td><td><b>Sous-douane</td><td><b>Hors douane</td><td><b>Catalogue</td><td><b>Hors catalogue</td><td><b>Valeur </td><td><b>Valeur moins</td><td><b>Valeur plus</td></tr>";
...
print <<"eof";
<form action=statproduit-do.pl name=choix>
...
print "<b>Sous-Douane</b>&nbsp;&nbsp;&nbsp;Tous<input type=checkbox name=tous Onclick=modif2c(\"t\")> <br><br><table border=0><tr>";
for ($i=0;$i<=$#f_ht;$i++){
...
Avec les stocks à zéro <input type=checkbox name=stock_null checked> Avec les stocks non null <input type=checkbox name=stock_nonnull checked>
</td>
</tr>
</table>
</form>
...
# -E edition des des information sur les code franchises , programme provisoire copier a partir de statproduiot : a finir
