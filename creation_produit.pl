...
if ($action eq "modif"){
	...
	if ($nb!=1){$pr_stanc=$pr_stre=$pr_diff=$pr_stvol=$pr_casse=0;}
	...
	&save("replace into produit value ('$pr_cd_pr','$pr_desi','$pr_casse','$pr_prx_rev','$pr_stre','$pr_douane','$pr_ventil','$pr_stanc','$pr_type','$pr_prx_vte','$pr_stvol','$pr_sup','$pr_emb','$pr_prac','$pr_deg','$pr_pdn','$pr_diff','$pr_acquit','$pr_orig','$pr_pdb','$pr_qte_comp','$pr_cond','$pr_devac','$pr_four','$pr_refour','$pr_codebarre')");
	# print "replace into produit value ('$pr_cd_pr','$pr_desi','$pr_casse','$pr_prx_rev','$pr_stre','$pr_douane','$pr_ventil','$pr_stanc','$pr_type','$pr_prx_vte','$pr_stvol','$pr_sup','$pr_emb','$pr_prac','$pr_deg','$pr_pdn','$pr_diff','$pr_acquit','$pr_orig','$pr_pdb','$pr_qte_comp','$pr_cond','$pr_devac','$pr_four','$pr_refour','$pr_codebarre')";
...
sub tetehtml()
{
	...
	print "<body background=../fond2.jpg link=white alink=white vlink=white><div class=ombre><center><font size=+5>Creation de produit</font>";
}
