...
$mois=`/bin/date '+%m'`;
$an="20".`/bin/date '+%y'`;
print "avisret 86<center><h1>Avis de Retour</h1><br><form>Date d'enlevement: Jour <input type=text name=jour value=$jour> Mois <input type=text name=mois value=$mois> Annee <input type=text name=annee value=$an><br>Heure (HH):<input type=text name=heure value=8><br>";
