...
$html=new CGI;
print $html->header;
print "<title>Mouvement produit</title>";
...
if ($action eq ""){
	...
	$sth = $dbh->prepare("select nav_nom from navire");
 	...
 	print "<br>2006 <input type=radio name=annee value=2006>";
   	...
   	print "<br>2008 <input type=radio name=annee value=2008>";
   	print "<br>2009 <input type=radio name=annee value=2009>";
   	print "<br>2010 <input type=radio name=annee value=2010>";
...
print "<tr><td>Retour Parfums,cosmetique</td><td>$total_genn</td></tr>";
