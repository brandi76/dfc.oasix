...
%compta_idx = &get_index_multiple("comptamatierebiere",1);            
open(FILE2,"/home/var/spool/uucppublic/comptamatierebiere.txt");     
@compta_dat = <FILE2>;
...
foreach (@index){
	print "<td colspan=2 align=center><font size=-1><b><font size=-3>Bieres $_<br></b>$unite</td>";
}
print "</tr><tr>";
foreach (@index){
