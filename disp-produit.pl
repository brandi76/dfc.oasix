...
print "<table border=0 width=100%><tr>\n";
	...
	print "<br><select name=\"devise\" onChange=recalcul(0);>\n";
        ...
        print "value=\"FF\">Francs Français</option>\n";
        print "<option ";
...
print "<center><input name=\"devise\" type=hidden value=\"$la_devise\"><b>Code du produit ou désignation : </b><input type=text name=code ";
