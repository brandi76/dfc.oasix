...
if ($action eq "detail_stock"){
	...
	print "<table><tr><th>code</th><th>désignation</th><th>qte</th><th>prix de revient</th><th>valeur</th><th>Vendu periode</th><th>Vendu post periode</th><th>Entree post periode</th></tr>";
