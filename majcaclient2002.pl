...
@facjoura_dat = `sort -t';' +1 /home/var/spool/uucppublic/facjour.txt`;
...
open(FILE,"> /home/var/spool/uucppublic/CAclient2002.txt");
foreach(@index){
...
close(FILE);
exec("/home/intranet/cgi-bin/suivi-commer-2002.pl");
